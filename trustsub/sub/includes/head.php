...
<head>
  ...
  <script>
    ...
    function openMedicalModal(a) {
      document.getElementById("modaladdRecord" + a).style.display = "block";
    }
    ...
    function closeAddModal(a) {
      document.getElementById("modaladdRecord" + a).style.display = "none";
    }
