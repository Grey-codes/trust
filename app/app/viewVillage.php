    ...
    <div id="appCapsule">
        ...
        <div class="appContent">
            ...
            <div class="sectionTitle mt-4 mb-0">
                <div class="text-muted">Village Survey</div>
                <div class="title">
                    <h1>Applications</h1>
                </div>
            </div>
            ...
            <div class="listView detailed" id="lists">
                ...
                $sl_id = mysqli_query($conn, "select * from village_survey where refer='$userId'");
                ...
                while ($j = mysqli_fetch_array($sl_id)) {
                    ...
                    <a href="#" class="listItem">
                        ...
                        <div class="text" id="name">
                            <div>
                                Village Name : <span style="font-weight:500; color:black;"><?php echo $j['VILLAGE_NAME']; ?>
                                    </strong></span>
                                <div class="text-muted" style="display:flex" id="id">
                                    ID <span style="font-weight:500; color:black;">
                                        &nbsp; : &nbsp;VS-<?php echo "" . $j['id']; ?></span>
                                </div>
