    ...
    <div id="appCapsule">
        <div class="appContent">
            ...
            <div class="listView detailed" id="lists">
                ...
                $sl_id = mysqli_query($conn, "select * from student where refer='$userId'");
                ...
                while ($j = mysqli_fetch_array($sl_id)) {
                    ...
                    <a href="#" class="listItem">
                        <div class="image">
                            <img
                            src="<?php echo htmlspecialchars($_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST'] . '/trust/api/student/' . $j['photo']); ?>"
                            alt="avatar"
                            class="avatar"
                            style="border-radius:50%; height:80px; width:80px; padding:10px;"
                            />
                        </div>
                        <div class="text" id="name">
                            <div>
                                Name : <span style="font-weight:500; color:black;">
                                    <?php echo $j['Student_Full_Name']; ?> </strong>
                                </span>
                                ...
                                <div class="text-muted" id="location" style="">
