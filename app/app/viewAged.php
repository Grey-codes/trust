    ...
    <div id="appCapsule">
        ...
        <div class="appContent">
            ...
            <div class="sectionTitle mt-4 mb-0">
                <div class="text-muted">Aged People</div>
                <div class="title">
                    <h1>Applications</h1>
                </div>
            </div>
            ...
            <div class="listView detailed" id="lists">
                ...
                $sl_id = mysqli_query($conn, "select * from widow_aged  where refer='$userId' and app_type=1");
                ...
                while ($j = mysqli_fetch_array($sl_id)) {
                    ...
                    <a href="#" class="listItem">
                        <div class="image">
                            <img
                            src="<?php echo htmlspecialchars($_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST'] . '/trust/api/widow/' .$j['photo']); ?>"
                            alt="avatar"
                            class="avatar"
                        ...
                        <div class="text" id="name">
                            <div>
                                Name : <span
                                    style="font-weight:500; color:black;"><?php echo $j['NAME_OF_THE_APPLICANTE']; ?>
                                    </strong></span>
                                <div class="text-muted" style="display:flex" id="id">
                                    ID <span style="font-weight:500; color:black;">
                                        &nbsp; : &nbsp;AG-<?php echo "" . $j['id']; ?></span>
                                </div>
